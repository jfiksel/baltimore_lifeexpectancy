...
* Highly correlated explanatory variables (using LASSO should take care of this)
...
### What to work on this week (and following weeks)

* Downloading and preprocessing data sources 
    + Tidy data
    + Identifiers for neighborhood and block
* Visualizing data
    + Spatial correlations for different variables by neighborhood
* Obtain data to define street blocks in R
* Research statistical issues in literature 
```{r load_packages, results='hide', echo=FALSE, eval=FALSE}
...
```{r download_pdfs, results='hide', echo=FALSE, eval=FALSE}
...
```{r process_pdfs, eval=FALSE, echo=FALSE}
